                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('doDaftar') }}" method="POST"
                                        ...
                                        <div class="col-12">
                                            <label for="yourUsername" class="form-label">Nomor Telpon Aktif</label>
                                            <input type="text" name="no_telpon" class="form-control"
                                                id="yourUsername" required />

                                        </div>
                                        <div class="col-12">
                                            <label for="yourUsername" class="form-label">Alamat Tinggal</label>
